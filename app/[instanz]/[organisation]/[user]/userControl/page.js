    ...
    <StyledPaper>
      <Box sx={{ padding: 4 }}>
                    ...
                    <TableCell>
                      <Grid>
                        <BlueButton
                          ...
                          sx={{ mx: 1 }} // Abstand links und rechts hinzufügen
                        >
        ...
        <Dialog open={editDialogOpen} onClose={() => setEditDialogOpen(false)}>
          ...
          <DialogActions>
            <RedButton onClick={() => setEditDialogOpen(false)} color="secondary">Abbrechen</RedButton>
            <GreenButton onClick={handleConfirmSave} color="primary">Speichern</GreenButton>
          </DialogActions>
        </Dialog>
        ...
        <Dialog open={confirmSaveDialogOpen} onClose={() => setConfirmSaveDialogOpen(false)}>
          ...
          <DialogActions>
            <RedButton onClick={() => setConfirmSaveDialogOpen(false)} color="secondary">Nein</RedButton>
            <GreenButton onClick={handleSaveChanges} color="primary">Ja</GreenButton>
          </DialogActions>
        </Dialog>
        ...
        <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
          ...
          <DialogActions>
            <RedButton onClick={() => setDeleteDialogOpen(false)} color="secondary">
              Nein
            </RedButton>
            <GreenButton onClick={confirmDeleteUser} color="error">
              Ja
            </GreenButton>
          </DialogActions>
        </Dialog>
